...
$("#next1").css("font-weight", "200");
});
$("#previous1").hover(function(){
$("#previous1").css("font-weight", "600");
});
$("#previous1").mouseout(function(){
$("#previous1").css("font-weight", "200");
});

// $("#image1-1").click(function(){
// $("#image1-1").css("opacity", "0.03");
// });
// $("#image1-1").click(function(){
// $("#image1-2").css("opacity", "0.03");
// });
// $("#image1-2").click(function(){
// $("#image1-1").css("opacity", "0.03");
// });
// $("#image1-2").click(function(){
// $("#image1-2").css("opacity", "0.03");
...
$("#image1-5").click(function(){
$("#image1-5").hide();
});
$("#image1-6").click(function(){
$("#image1-6").hide();
});
